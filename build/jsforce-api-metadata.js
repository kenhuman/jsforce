...
Metadata.prototype.describeValueType = function(type, version, callback) {
  ...
  return this._invoke("describeValueType", { type: "{http://soap.sforce.com/2006/04/metadata}" + type }).then(function(res) {
    ...
    function convertValueTypeFieldTypes(valueTypeField) {
      ...
      valueTypeField.fields = _.map(valueTypeField.fields, function(field) {
        field.isForeignKey = field.isForeignKey === 'true';
        field.isNameField = field.isNameField === 'true';
        field.valueRequired = field.valueRequired === 'true';
        field.minOccurs = Number(field.minOccurs)
        return field;
      });
      ...
      valueTypeField.minOccurs = Number(res.minOccurs);
...
Metadata.prototype.checkRetrieveStatus = function(id, callback) {
  return this._invoke("checkRetrieveStatus", { asyncProcessId: id }).then(function(res) {
 ...
 * 
 * @param {String} validationId - Id returned from deploy with checkOnly set to true
 * @param {Callback.<Metadata~DeployRecentValidationResult} [callback] - Callback function
 * @returns {Promise.<Metadata~DeployRecentValidationResult>}
 */
Metadata.prototype.deployRecentValidation = function(validationId, callback) {
  return this._invoke("deployRecentValidation", { validationId: validationId }, callback);
}
